  ...
  return (
    <div className="mt-[60px] md:mt-[80px]">
      ...
      <section className="bg-gradient-2 py-32 flex flex-col justify-center items-start">
        <div className="container mx-auto px-6 sm:px-12">
          ...
          <p className="text-xl mb-10 text-white">
            Join SFU Open Source Development Club and collaborate with tech,
            design, and business students on projects that make a real impact.
            Build, learn, and grow together as we drive positive change through
            technology.
          </p>
          <a
            href="#about"
        ...
        <div className="flex flex-col space-y-8 md:flex-row md:space-x-8 md:space-y-0">
          ...
          <div className="md:w-1/2">
            <p className="text-lg mb-6">
              ...
              . Our primary goal is to collaborate on projects that{" "}
              <strong className="text-primary">
                contribute to the community
              </strong>{" "}
              while providing valuable{" "}
              <strong className="text-primary">learning opportunities</strong>{" "}
              for our members.
            </p>
            <p className="text-lg mb-6">
      ...
      <section className="container mx-auto py-16 px-6 sm:px-12">
        <h2 className="section-title text-center font-club md:text-left">
          Our Value to You
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center p-8 text-center text-primary-light">
            <svg
              ...
              height="75"
              fill="currentColor"
              className="bi bi-briefcase-fill mb-4"
              viewBox="0 0 16 16"
            >
            ...
            <p className="text-gray-300">
              <strong className="text-primary">Tackle</strong> real-world
              challenges through{" "}
              <strong className="text-primary">hands-on projects</strong>.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center p-8 text-center text-primary-light">
            <svg
              ...
              height="75"
              fill="currentColor"
              className="bi bi-flag-fill mb-4"
              viewBox="0 0 16 16"
            >
            ...
            <p className="text-gray-300">
              <strong className="text-primary">Gain</strong> leadership
              experience by leading{" "}
              <strong className="text-primary">impactful projects</strong>.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center p-8 text-center text-primary-light">
            <svg
              ...
              height="75"
              fill="currentColor"
              className="bi bi-people-fill mb-4"
              viewBox="0 0 16 16"
            >
            ...
            <p className="text-gray-300">
              <strong className="text-primary">Connect</strong> and collaborate
              with a community of{" "}
              <strong className="text-primary">talented peers</strong>.
            </p>
          </div>
        </div>
      </section>

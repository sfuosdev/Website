    ...
    <div className="mt-[60px] md:mt-[80px]">
      ...
      <section className="bg-gradient-2 py-32 flex flex-col justify-center items-start">
        <div className="container mx-auto px-6 sm:px-12">
          <h1 className="text-6xl font-bold font-club mb-6 text-white">Resources</h1>
      ...
      <section id="projects-section" className="container mx-auto py-16 px-6 sm:px-12">
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
          {/* Collaborate with Us Column */}
          <div className="flex-1 space-y-6">
            <h2 className="section-title text-left font-club">Collaborate with Us</h2>
            <a 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-github mr-2" viewBox="0 0 16 16">
            ...
            <a 
              ...
              className="flex items-center justify-center btn btn-third"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-discord mr-2" viewBox="0 0 16 16">
          ...
          <div className="flex-1 space-y-6">
            <h2 className="section-title text-left font-club">Learn and Explore</h2>
            <a 
              ...
              className="flex items-center justify-center btn btn-third"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-file-earmark-fill mr-2" viewBox="0 0 16 16">
            ...
            <a
              ...
              className="flex items-center justify-center btn btn-third"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-bookmark-plus-fill mr-2" viewBox="0 0 16 16">
